...
{
    [DataContract(Namespace = ServiceConstants.V1_SERVICE_NAMESPACE, Name = "DateMonthYearReportParamContract")]
    public class DateMonthYearReportParam : ReportParam
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the DateMonthYearReportParam class
        /// </summary>
        ...
        public DateMonthYearReportParam(String name, String displayText, Boolean isRequired, String premiseMetadata, EntityTypeTag entityType,
        ...
        /// <param name="maximumValue"></param>
        /// <param name="defaultCurrent"></param>
        public DateMonthYearReportParam(String name, String displayText, Boolean isRequired, String premiseMetadata,
            DateTime? defaultValue, DateTime? minimumValue, DateTime? maximumValue, Boolean? defaultCurrent)
        ...
        /// <summary>
        /// Initializes a new instance of the DateMonthYearReportParam class from an existing instance and a collection of propertyTuples
        /// </summary>
        /// <param name="source"></param>
        /// <param name="propertyTuples"></param>
        public DateMonthYearReportParam(DateMonthYearReportParam source, IEnumerable<PropertyTuple> propertyTuples)
            : base(source, propertyTuples)
        {
            ...
            var myPropertyTuples = propertyTuples.Where(x => x.Item1.DeclaringType == typeof(DateMonthYearReportParam));
