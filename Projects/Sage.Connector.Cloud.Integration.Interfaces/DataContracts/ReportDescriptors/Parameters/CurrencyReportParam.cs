...
{
    [DataContract(Namespace = ServiceConstants.V1_SERVICE_NAMESPACE, Name = "CurrencyReportParamContract")]
    public class CurrencyReportParam : NumberReportParam
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the CurrencyReportParam class 
        /// </summary>
        ...
        public CurrencyReportParam(String name, String displayText, Boolean isRequired, String premiseMetadata, EntityTypeTag entityType,
        ...
        /// <param name="disallowZero"></param>
        /// <param name="showZeroAsBlank"></param>
        public CurrencyReportParam(String name, String displayText, Boolean isRequired, String premiseMetadata,
            Decimal? defaultValue, Int32? scale, Int32? precision, Decimal? minimumValue, Decimal? maximumValue, ReportParameterIntegerTypes integerType,
            Boolean? commaGrouping, Boolean? disallowZero, Boolean? showZeroAsBlank)
        ...
        public CurrencyReportParam(CurrencyReportParam source, IEnumerable<PropertyTuple> propertyTuples)
            : base(source, propertyTuples)
        {
            // add assignments for properties belonging to this class, e.g.,
            // Property1 = source.Property1;
            
            var myPropertyTuples = propertyTuples.Where(x => x.Item1.DeclaringType == typeof(CurrencyReportParam));
