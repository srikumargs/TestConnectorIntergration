...
{
    [DataContract(Namespace = ServiceConstants.V1_SERVICE_NAMESPACE, Name = "DateReportParamContract")]
    public class DateReportParam : ReportParam
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the DateReportParam class
        /// </summary>
        ...
        public DateReportParam(String name, String displayText, Boolean isRequired, String premiseMetadata, EntityTypeTag entityType,
        ...
        /// <param name="maximumValue"></param>
        /// <param name="defaultCurrent"></param>
        public DateReportParam(String name, String displayText, Boolean isRequired, String premiseMetadata,
            DateTime? defaultValue, DateTime? minimumValue, DateTime? maximumValue, Boolean? defaultCurrent)
        ...
        public DateReportParam(DateReportParam source, IEnumerable<PropertyTuple> propertyTuples)
            : base(source, propertyTuples)
        {
            ...
            var myPropertyTuples = propertyTuples.Where(x => x.Item1.DeclaringType == typeof(DateReportParam));
