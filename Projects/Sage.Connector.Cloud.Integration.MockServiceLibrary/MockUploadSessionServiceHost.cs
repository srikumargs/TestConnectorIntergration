...
namespace Sage.Connector.Cloud.Integration.MockServiceLibrary
{
    ...
    /// 
    /// </summary>
    public static class MockUploadSessionServiceHost
    {
        /// <summary>
        /// 
        /// </summary>
        public static void StartService()
        {
            ...
            _serviceHost = new ServiceHost(typeof(UploadSessionService), new[] { new Uri(String.Format("http://{0}:8732", Environment.MachineName)) });
            ServiceEndpoint serviceEndpoint =
                _serviceHost.AddServiceEndpoint(typeof(IUploadSessionService), binding, "/UploadSessionService/UploadSessionService.svc");
