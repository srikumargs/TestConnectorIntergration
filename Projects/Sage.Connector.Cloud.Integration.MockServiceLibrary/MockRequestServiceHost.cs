...
namespace Sage.Connector.Cloud.Integration.MockServiceLibrary
{
    ...
    /// 
    /// </summary>
    public static class MockRequestServiceHost
    {
        /// <summary>
        /// 
        /// </summary>
        public static void StartService()
        {
            ...
            _serviceHost = new ServiceHost(typeof(RequestService), new[] { new Uri(String.Format("http://{0}:8732", Environment.MachineName)) });
            ServiceEndpoint serviceEndpoint =
                _serviceHost.AddServiceEndpoint(typeof(IRequestService), binding, "/RequestService/RequestService.svc");
