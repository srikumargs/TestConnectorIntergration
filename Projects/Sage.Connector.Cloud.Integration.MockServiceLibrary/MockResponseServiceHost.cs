...
namespace Sage.Connector.Cloud.Integration.MockServiceLibrary
{
    ...
    /// 
    /// </summary>
    public static class MockResponseServiceHost
    {
        /// <summary>
        /// 
        /// </summary>
        public static void StartService()
        {
            ...
            _serviceHost = new ServiceHost(typeof(ResponseService), new[] { new Uri(String.Format("http://{0}:8732", Environment.MachineName)) });
            ServiceEndpoint serviceEndpoint =
                _serviceHost.AddServiceEndpoint(typeof(IResponseService), binding, "/ResponseService/ResponseService.svc");
